            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                           ...
                           <h3><?=$projet['intitule_projet']?></h3>
                                ...
                                <table class="table table-bordered">
                                            ...
                                            <?php while($partenaire=$partenaires->fetch()){?>
                                                <tr>
                                                    ...
                                                    <td><?=$partenaire['contribution']?>&nbsp Mdh</td>
                                                    <td><?=$partenaire['montant_verse']?>&nbsp Mdh</td>
                                                </tr>
                                            <?php }?>
                                </table>
                                <div class="act-etude">
                            ...
                            <tbody>
                                ...
                                <td><?=$projet['nbr_dossiers']?></td>
                                    <td class="li"><a href="<?php if ($projet['pv_reception']=='') {echo "erreur.php" ;}else { echo "../projets/pv_reception/".$projet['pv_reception'] ;  }?>" class="li">Pv_reception.pdf</a></td>
                                    <td><a href="<?php if ($projet['AMI']=='') {echo "erreur.php" ;}else { echo "../projets/AMI/".$projet['AMI'] ;  }?>" class="li">AMI.pdf</a></td>
                                    <td><a href="<?php if ($projet['plan_recoulement']=='') {echo "erreur.php" ;}else { echo "../projets/plan_recoulement/".$projet['plan_recoulement'] ;  }?>" class="li">Plan de recoulement.pdf</a></td>
                                    <td><a href="<?php if ($projet['pv_selection']=='') {echo "erreur.php" ;}else { echo "../projets/pv_selection/".$projet['pv_selection'] ;  }?>" class="li">Pv_selection.pdf</a></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="phase">
                        ...
                        <div class="act">
                                    <button class="btn btn-primary"><a href="ajouter_non_opeationels.php?id=<?=$projet['id']?>">Modifier</a></button>
                                    <button class="btn btn-primary"><a href="ajouter_operationels.php?id=<?=$get_id?>">Projet Opérationnel</a></button>
