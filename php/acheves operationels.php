...
<html lang="en">
    <head>
        ...
        <title>Projets achéves opérationels</title>
                ...
                <nav class="sb-sidenav accordion sb-sidenav" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="acheves operationels.php">
                                <div class="sb-nav-link-icon"><i class="fa fa-university" aria-hidden="true"></i></div>
                ...
                <main>
                    <div class="container-fluid">
                        <div class="ajout-recherche">
                            <div class="recherche">
                            <form action="acheves operationels.php" method="POST">
                    ...
                    <table  class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                while($projet=$projets->fetch()){
                                    if($projet['date_exploitation']!=0000-00-00){
                                ?>
                                    <tr>
                                        <th><?=$projet['id']?></th>
                                        <th scope="row"><i class="fa fa-folder-open" aria-hidden="true"></i>&nbsp;<a href="rapport_operationel.php?id=<?=$projet['id']?>"><?=str_replace("\'","'",$projet['intitule_projet'])?></th>
                                        <td><?=$projet['region']?></td>
