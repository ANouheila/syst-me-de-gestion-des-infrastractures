...
if(!isset($_SESSION['id'])) {
    ...
    //recuperer la liste des projets selon la recherche
...
<html lang="en">
    <head>
        ...
        <title>Projets achéves non operationels</title>
                ...
                <nav class="sb-sidenav accordion sb-sidenav" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="acheves non operationels.php">
                ...
                <main>
                    <div class="container-fluid">
                        <div class="ajout-recherche">
                            <div class="recherche">
                            <form action="acheves non operationels.php" method="POST">
                    ...
                    <table  class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                while($projet=$projets->fetch()){
                                    if($projet['ordre_service']!=0000-00-00 and $projet['nbr_dossiers']!=0 and $projet['date_exploitation']==0000-00-00){
                                ?>
                                    <tr>
                                        <th><?=$projet['id']?></th>
                                        <th scope="row"><i class="fa fa-folder-open" aria-hidden="true"></i>&nbsp;<a href="rapport_non_operationel.php?id=<?=$projet['id']?>"><?=str_replace("\'","'",$projet['intitule_projet'])?></th>
                                        <td><?=$projet['region']?></td>
