...
<html lang="en">
    <head>
        ...
        <title>Projets en cours de convention</title>
                ...
                <nav class="sb-sidenav accordion sb-sidenav" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="convention.php">
                ...
                <main>
                    <div class="container-fluid">
                        <div class="ajout-recherche">
                            <div class="recherche">
                                <form action="convention.php" method="POST">
                        ...
                        <div class="ajouter">
                               <a href="traitement_convention.php"><button type="button" id="open" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Nouveau Projet</button></a>
                        </div>
                    </div>
                    <table  class="table table-bordered">
                            <thead>
                                ...
                                <th scope="col">Convention signé le:</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                while($projet=$projets->fetch()){
                                    if($projet['superficie_glob']==0){
                                ?>
                                    <tr>
                                        <th><?=$projet['id']?></th>
                                        <th scope="row"><i class="fa fa-folder-open" aria-hidden="true"></i>&nbsp;<a href="rapport.php?id=<?=$projet['id']?>"><?=str_replace("\'","'",$projet['intitule_projet'])?></th>
                                        <td><?=$projet['region']?></td>
                                        <td><?=$projet['province']?></td>
                                        <td><?=$projet['date_signature']?></td>   
                                    </tr>
                                <?php }}?>
                            </tbody>
                        </table>
