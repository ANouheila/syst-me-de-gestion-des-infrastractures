...
<html lang="en">
    <head>
        ...
        <title>Projets en cours de chantier</title>
                ...
                <nav class="sb-sidenav accordion sb-sidenav" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="chantier.php">
                    ...
                    <table  class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                while($projet=$projets->fetch()){
                                    if($projet['ordre_service']!=0000-00-00 and $projet['date_lancement_AMI']==0000-00-00){
                                ?>
                                    <tr>
                                        <th><?=$projet['id']?></th>
                                        <th scope="row"><i class="fa fa-folder-open" aria-hidden="true"></i>&nbsp;<a href="rapport_chantier.php?id=<?=$projet['id']?>"><?=str_replace("\'","'",$projet['intitule_projet'])?></th>
                                        <td><?=$projet['region']?></td>
