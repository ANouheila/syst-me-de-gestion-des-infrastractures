...
if(!empty($_POST))
{
    ...
    if(isset($_POST['ajouter'])){
        try {
            ...
            $demande=$bdd->prepare("UPDATE projets SET ordre_service=:ordre_service,date_achevement=:date_achevement,date_achevement_pre=:date_achevement_pre,etapes=:etapes,observation=:observation WHERE id=:id");
...
<html lang="en">
    <head>
        ...
        <title>Suivie de chantier</title>
                ...
                <main>
                    <div class="container-fluid">
                        <div class="ajout-formulaire">
                                    <h3>Suivie De chantier Du <?=$projet['intitule_projet']?></h3>
                                      <form class="row g-3" method="post" action="ajouter_chantier.php?id=<?=$get_id?>"  enctype="multipart/form-data">
                                    <div class="col-md-4 chantier">
                                        <label for="validationServerUsername" class="form-label">Ordre de service</label>
                                        <div class="input-group has-validation">
                                        <input type="date" class="form-control" name="ordre_service"id="validationServerUsername" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 chantier">
                                        <label for="validationServer05" class="form-label">Date previsionnelle d'achevement du projet</label>
                                        <input type="date" class="form-control" id="validationServer05" name="date_achevement_pre" aria-describedby="validationServer05Feedback" required>
                                    </div>
                                    <div class="col-md-4 chantier">
                                        <label for="validationServer05" class="form-label">Date d'achevement du projet</label>
                                        <input type="date" class="form-control" id="validationServer05" name="date_achevement" aria-describedby="validationServer05Feedback" required>
                                    </div>
                                    ...
                                    <div class="col-md-12 chantier obs">
                                            ...
                                            <label for="validationServer02" class="form-label">Le planning De réalisation</label>
                                                <input type="file" class="form-control file" aria-label="file example" name="planning_realisation" required>
                                            </div>
                                    </div>
                                    <div class="col-12 field">
                                            <label class="form-check-label" for="invalidCheck3">
                                    ...
                                    <div class="col-md-2">
                                        <button class="btn btn-primary convention" type="submit" name="ajouter">Ajouter</button>
                                    </div>
                                    </form>
                        </div>
                    </div>
