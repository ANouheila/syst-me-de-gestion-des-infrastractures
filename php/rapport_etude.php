                        ...
                        <div class="rapport">
                           <h3><?=$projet['intitule_projet']?></h3>
                            <div>
                                ...
                                <div class="item"><b>Type de l'infrastarcture</b> : <?=$projet['type']?></div>
                                ...
                                <div class="item">
                                 <?=str_replace('\\','',$projet['observation'])?>
                                </div>
                                
                                <div class="act">
                                    <button class="btn btn-primary"><a href="modifier_etude.php?id=<?=$projet['id']?>">Modifier</a></button>
                                    <button class="btn btn-primary"><a href="ajouter_chantier.php?id=<?=$get_id?>">Suivie de chantier</a></button>
